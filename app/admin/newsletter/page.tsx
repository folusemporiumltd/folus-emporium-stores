...
async function sendNewsletter(formData:FormData){
  ...
  if(!isVerifiedDomainSender(from)) redirect('/admin/newsletter?error='+encodeURIComponent('Customer newsletter sending is locked until a verified Folus Emporium Stores domain is configured in NEWSLETTER_FROM_EMAIL.'))
