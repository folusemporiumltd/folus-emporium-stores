...
async function sendResendTest() {
  ...
  const response = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      from: TEST_FROM,
      to: [TEST_TO],
      subject: 'Folus Emporium Stores Resend integration test',
      text: 'Folus Emporium Stores website successfully connected to Resend.',
      html: '<strong>Folus Emporium Stores website successfully connected to Resend.</strong>',
    }),
    cache: 'no-store',
  })
      ...
      <header className="nav">
        <div className="container nav-inner">
          <Link className="brand" href="/admin/dashboard">
            <img src="/folus-emporium-circular-logo.png" alt="Folus Emporium Stores logo" />
