...
export default function WishlistPage() {
  ...
  return <main>
    <div className="topbar"><div className="container"><span>Saved for later</span><span>Folus Emporium Stores Wishlist</span></div></div>
    <header className="nav"><div className="container nav-inner"><Link className="brand" href="/"><img src="/folus-emporium-circular-logo.png" alt="Folus Emporium Stores circular logo"/><span>FOLUS<br/>EMPORIUM STORES<small>Curating Excellence for Life’s Finest Moments.</small></span></Link><nav className="navlinks"><Link href="/">Home</Link><Link href="/shop">Shop</Link><Link href="/cart">Cart</Link><Link href="/account">My Account</Link></nav></div></header>
