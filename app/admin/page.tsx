...
export default async function AdminPage() {
  ...
  return <main>
    <div className="topbar"><div className="container"><span>Folus Emporium Stores Admin</span><span>Catalogue & orders</span></div></div>
    <header className="nav"><div className="container nav-inner"><a className="brand" href="/admin/dashboard"><img src="/folus-emporium-circular-logo.png" alt="Folus Emporium Stores logo"/><span>FOLUS<br/>EMPORIUM STORES<small>Admin</small></span></a><nav className="navlinks"><a href="/admin/dashboard">Dashboard</a><a href="/admin/coupons">Coupons</a><a href="/admin/users">Roles</a><a href="/">Storefront</a><a href="/account">Account</a></nav></div></header>
