...
export default async function AIVirtualAssistantPage(){
  ...
  return <main className="admin-dashboard-shell">
    <div className="topbar"><div className="container"><span>Folus Emporium Stores Administration</span><span>AI Virtual Assistant</span></div></div>
    <header className="nav"><div className="container nav-inner"><Link className="brand" href="/admin/dashboard"><img src="/folus-emporium-circular-logo.png" alt="Folus Emporium Stores logo"/><span>FOLUS<br/>EMPORIUM STORES<small>AI Virtual Assistant</small></span></Link><nav className="navlinks"><Link href="/admin/dashboard">Dashboard</Link><Link href="/admin/reports">Reports</Link><Link href="/admin/products">Products</Link><Link href="/admin/orders">Orders</Link><Link href="/admin/customers">Customers</Link></nav></div></header>
    <section className="section" style={{paddingTop:42}}><div className="container">
      ...
      <p className="muted" style={{marginTop:18,fontSize:12}}>Signed in as {user.email}. Agent activity is restricted to authorised Folus Emporium Stores administrators and logged for accountability.</p>
    </div></section>
  </main>
}
