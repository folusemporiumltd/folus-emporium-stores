...
{q:'What payment methods are available?',a:<>Folus Emporium Stores supports secure online payment through Paystack and may offer Pay After Delivery for eligible orders.</>},
...
{q:'What should I provide when asking about a delivery?',a:<>Provide your order reference so the Folus Emporium Stores team can locate the order quickly.</>}]},
...
{q:'How do I use a coupon?',a:<>Enter a valid Folus Emporium Stores coupon code during checkout before payment. If accepted, the discount will appear in your order total.</>},
...
{q:'How do I request a return or refund?',a:<>Review the <Link href="/return-policy">Return Policy</Link>, then contact Folus Emporium Stores with your order reference, product details and a clear description of the issue.</>},
...
{id:'support',title:'Contact Support',description:'Reach Folus Emporium Stores when you need personal assistance.',icon:'🎧',questions:[
{q:'How can I contact Folus Emporium Stores?',a:<div className="help-contact"><a className="btn btn-outline" href="https://wa.me/2349168157255">WhatsApp Support</a><a className="btn btn-outline" href="mailto:folusemporium@gmail.com">Email Support</a><Link className="btn btn-outline" href="/contact">Contact page</Link></div>},
