      ...
      <form style={{ display: 'grid', gap: 14, maxWidth: 760 }}>
        <label>
          ...
          <input
            ...
            placeholder="e.g. Fresh from Folus Emporium Stores this week"
          />
        </label>
        <label>
          Preview text
        ...
        {canSendCustomers ? (
          ...
          <div role="status" style={{ background: '#fff6df', border: '1px solid #efd9a0', borderRadius: 10, padding: 14 }}>
            <strong>Customer sending is locked.</strong> You can compose, preview and send tests now. Verify a Folus Emporium Stores domain in Resend before sending to customers.
          </div>
        )}
      </form>
    </section>
